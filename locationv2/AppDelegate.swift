...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate, RadarDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions:
        ...
        Radar.initialize(publishableKey: "prj_test_pk_931aa793577c14bb4903b52168694ec5b077a6ef")
       
        Radar.setDelegate(self)
        
        //foreground
        Radar.trackOnce { (status, location, events, user) in user?.geofences?.forEach { (geofence) in
            if geofence.tag == "park" {
               print("You made it!")
            }
            }
    ...
    // MARK: - Core Data stack
       ...
       lazy var persistentContainer: NSPersistentContainer = {
           ...
           */
           let container = NSPersistentContainer(name: "locationv2")
